...
3. Open the app once after the upgrade and confirm the persistent “远桥正在运行” notification appears. In OnePlus system settings, allow autostart and background activity, disable battery optimization for the app, and lock it in Recents where OxygenOS provides that control.
