...
External gates: Android phone permissions and actual OTP latency; offline/online delete convergence; process death and reboot; iPhone PWA install, Bark privacy/full choice and Web Push; DNS/TLS; server reboot; 72-hour normal operation; seven-day soak. Record timestamps, OS/app versions and observable outcomes. Never convert an unexecuted external gate into PASS.
